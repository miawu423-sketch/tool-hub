...
(function () {
  ...
  style.textContent = [
    ...
    'opacity:0;transform:translateY(-4px);transition:opacity .12s,transform .12s;pointer-events:auto;user-select:none}',
    '#tsx-bubble.tsx-show{opacity:1;transform:translateY(0)}',
